  ...
  if (submitted) {
    return (
      <div
        ...
        style={{
          backgroundImage: "url('/84753c1d-5515-40b2-abdf-b8d9d700e9fb.png')",
        }}
      >
        <div className="absolute inset-0 bg-black opacity-60 z-0"></div>
        <div className="relative z-10 text-center p-6 bg-black/80 backdrop-blur-md rounded-xl shadow-xl max-w-md w-full">
  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="relative z-10 w-full max-w-md bg-black/80 backdrop-blur-md text-white p-8 rounded-xl shadow-2xl"
      >
